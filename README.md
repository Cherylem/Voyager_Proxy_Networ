...
1. **Скачайте установщик**: [VoyagerProxy.dmg](https://your-download-link.com)
2. **Откройте файл** `VoyagerProxy.dmg`
3. **Перетащите** иконку VoyagerProxy в папку Applications
4. **Запустите** из Launchpad

### 🚀 Первый запуск:

Если видите предупреждение безопасности:
1. Нажмите **⌘ + Пробел** и введите `VoyagerProxy`
2. Нажмите на приложение **правой кнопкой** → **"Открыть"**
3. Нажмите **"Открыть"** в диалоговом окне
